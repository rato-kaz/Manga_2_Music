...
from src.core.pipeline.pipeline_generate_json import generate_json_for_chapter as base_generate_json
from src.core.visual_analysis.character_reid import (
    CharacterDetection,
    CharacterFeatureExtractor,
    reidentify_characters,
)
from src.core.visual_analysis.manpu_detector import aggregate_emotions, detect_manpu_in_panel
from src.core.visual_analysis.onomatopoeia_classifier import detect_onomatopoeia_in_panel

# Import new modules
from src.core.visual_analysis.reading_order import detect_4koma_layout, estimate_reading_order
from src.core.visual_analysis.speaker_diarization import Character as SpeakerCharacter
