...
class AudioMixer:
    ...
    def create_transition(
        ...
        """
        # Load audio files
        bgm1 = self.load_audio(panel1_audio.get("bgm_path")) if panel1_audio.get("bgm_path") else None
        bgm2 = self.load_audio(panel2_audio.get("bgm_path")) if panel2_audio.get("bgm_path") else None
