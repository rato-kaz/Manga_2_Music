...
def find_character_by_tail_direction(
    ...
    tail_vector = (
        tail_point[0] - bubble_center[0],
        tail_point[1] - bubble_center[1]
    )
    ...
    for char in characters:
        ...
        char_vector = (
            char_center[0] - bubble_center[0],
            char_center[1] - bubble_center[1]
        )
...
def infer_speaker_with_llm(
    ...
    # Build prompt
    character_names = [char.character_name or f"Character_{char.character_id}" for char in characters]
